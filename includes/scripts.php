...
function ecava_diot_scada_register_scripts() {
	...
	wp_register_script('ecava_diot_scada_mqtt_subscriber', ECAVA_DIOT_SCADA_URL. "js/eds_mqttsub.js" , array( 'jquery', 'ecava_diot_scada_mqtt_client_library', 'ecava_diot_scada_jsonpath', 'ecava_diot_scada_flot_time'), $ecava_diot_scada_mqtt_subs_vers);
